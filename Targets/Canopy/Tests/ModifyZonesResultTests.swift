...
@Suite struct ModifyZonesResultTests {
  @Test func test_codes() throws {
    ...
    #expect(decoded.savedZones[1].zoneID.zoneName == "someZone2")
    #expect(decoded.deletedZoneIDs[1].zoneName == "deletedId2")
  }
  ...
  @Test func test_throws_on_bad_saved_zones_data() {
    ...
    do {
      ...
      #expect(context.debugDescription == "Invalid saved zones value in source data")
    } catch {
