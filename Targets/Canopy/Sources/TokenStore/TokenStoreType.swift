...
public protocol TokenStoreType {
  ...
  /// You should call this yourself when you need to reset your client to a state where it doesn’t have any tokens stored and
  /// should start over from a fresh state.
  func clear() async
}
